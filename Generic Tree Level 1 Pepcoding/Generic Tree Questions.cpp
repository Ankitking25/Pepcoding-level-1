...
int lowest_common_ancestor(Node *node, int data1, int data2)
{
  
    // Write your code here
    vector<int> path1=*rootNodeToPath(node,data1);   //call rootNodetopath and Node to root both are same,Diff in pointer taken:
...
int Distance_between_two_node(Node *node, int data1, int data2)
{
...
int main()
{
  ...
  bool flag =find_element(t,80); 
    ...
    cout<<"]";
 */  
 cout<<"The lowest_common_ancestor mean we pass two datas , data1 and data2 and edge of meeting of both data called ansestor"<<endl;
   int lca = lowest_common_ancestor(t,120,80);
   cout<<lca<<endl;
   cout<<"The Distance Between two node is "<<endl;
   int dbt=Distance_between_two_node(t,20,110);
   cout<<dbt<<endl;
